 ...
 * 
 *
 * Example to demonstrate the sample implementation of  {@link se.ecostruxure.sdk.client.PerformanceScoreApi#listPerformanceScores(String, List, List)}
 * 
 * @author pushkar_sinha
 */
public class ListPerformanceScore {
	...
	public static void main(String[] args) {
		...
		// String |
		try {
			List<PerformanceScore> performanceScore = apiInstance.listPerformanceScores(siteId, null, null);
	...
	public static Map<String, Object> getDetailsErrorMessage(String errorMessage) {
		...
		details.put("type", "/ListPerfomance");
