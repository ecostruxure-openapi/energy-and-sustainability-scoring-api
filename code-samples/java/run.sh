...
if [[ $className != "GetSites" && $className != "CreateScoringRequests" && $className != "GetScoringRequest" && $className != "ListPerformanceScore" ]] ; then
...
elif [[ $className == "GetScoringRequest" ]] ; then
...
elif [[ $className == "ListPerformanceScore" ]] ; then
