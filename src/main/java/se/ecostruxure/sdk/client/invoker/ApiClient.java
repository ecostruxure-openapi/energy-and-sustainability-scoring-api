...
import se.ecostruxure.sdk.client.invoker.auth.Authentication;
...
@Component("se.ecostruxure.sdk.client.invoker.ApiClient")
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://se-exchange-uat-uat.apigee.net/ecostruxure/user/v1";
